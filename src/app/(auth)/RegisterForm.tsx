          ...
          <>
            <section className="grid gap-4 rounded-xl border border-border bg-white/95 p-6 shadow-sm">
              ...
              <div className="grid gap-4 xl:grid-cols-2">
                ...
                <Input label="Ghana Card or ID Number" name="idNumber" required={role === "RIDER"} />
                <Input label="Rider or Driver License Number" name="riderLicenseNumber" required={role === "RIDER"} />
